...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-list>\n  <ion-item *ngFor=\"let item of items; let i = index\" detail\n  (click)=\"onClick(i+1)\">\n    <ion-label>item {{ i+1 }}</ion-label>\n  </ion-item>\n</ion-list>");
...
const routes = [
    ...
    {
        path: 'botones',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-botones-botones-module */ "pages-botones-botones-module").then(__webpack_require__.bind(null, /*! ./pages/botones/botones.module */ "./src/app/pages/botones/botones.module.ts")).then(m => m.BotonesPageModule)
    },
    {
        path: 'card',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-card-card-module */ "pages-card-card-module").then(__webpack_require__.bind(null, /*! ./pages/card/card.module */ "./src/app/pages/card/card.module.ts")).then(m => m.CardPageModule)
    },
    {
        path: 'check',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-check-check-module */ "pages-check-check-module").then(__webpack_require__.bind(null, /*! ./pages/check/check.module */ "./src/app/pages/check/check.module.ts")).then(m => m.CheckPageModule)
    },
    {
        path: 'date-time',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-date-time-date-time-module */ "pages-date-time-date-time-module").then(__webpack_require__.bind(null, /*! ./pages/date-time/date-time.module */ "./src/app/pages/date-time/date-time.module.ts")).then(m => m.DateTimePageModule)
    },
    {
        path: 'fab',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-fab-fab-module */ "pages-fab-fab-module").then(__webpack_require__.bind(null, /*! ./pages/fab/fab.module */ "./src/app/pages/fab/fab.module.ts")).then(m => m.FabPageModule)
    },
    {
        path: 'grid',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-grid-grid-module */ "pages-grid-grid-module").then(__webpack_require__.bind(null, /*! ./pages/grid/grid.module */ "./src/app/pages/grid/grid.module.ts")).then(m => m.GridPageModule)
    },
    {
        path: 'infinite-scroll',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-infinite-scroll-infinite-scroll-module */ "pages-infinite-scroll-infinite-scroll-module").then(__webpack_require__.bind(null, /*! ./pages/infinite-scroll/infinite-scroll.module */ "./src/app/pages/infinite-scroll/infinite-scroll.module.ts")).then(m => m.InfiniteScrollPageModule)
    },
    {
        path: 'input',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-input-input-module */ "pages-input-input-module").then(__webpack_require__.bind(null, /*! ./pages/input/input.module */ "./src/app/pages/input/input.module.ts")).then(m => m.InputPageModule)
    },
    {
        path: 'list',
    ...
    {
        path: 'list-reorder',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-list-reorder-list-reorder-module */ "pages-list-reorder-list-reorder-module").then(__webpack_require__.bind(null, /*! ./pages/list-reorder/list-reorder.module */ "./src/app/pages/list-reorder/list-reorder.module.ts")).then(m => m.ListReorderPageModule)
    },
    {
        path: 'loading',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-loading-loading-module */ "pages-loading-loading-module").then(__webpack_require__.bind(null, /*! ./pages/loading/loading.module */ "./src/app/pages/loading/loading.module.ts")).then(m => m.LoadingPageModule)
    },
    {
        path: 'modal',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-modal-modal-module */ "pages-modal-modal-module").then(__webpack_require__.bind(null, /*! ./pages/modal/modal.module */ "./src/app/pages/modal/modal.module.ts")).then(m => m.ModalPageModule)
    },
    {
        path: 'popover',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-popover-popover-module */ "pages-popover-popover-module").then(__webpack_require__.bind(null, /*! ./pages/popover/popover.module */ "./src/app/pages/popover/popover.module.ts")).then(m => m.PopoverPageModule)
    },
    {
        path: 'progress-bar',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-progress-bar-progress-bar-module */ "pages-progress-bar-progress-bar-module").then(__webpack_require__.bind(null, /*! ./pages/progress-bar/progress-bar.module */ "./src/app/pages/progress-bar/progress-bar.module.ts")).then(m => m.ProgressBarPageModule)
    },
    {
        path: 'refresher',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-refresher-refresher-module */ "pages-refresher-refresher-module").then(__webpack_require__.bind(null, /*! ./pages/refresher/refresher.module */ "./src/app/pages/refresher/refresher.module.ts")).then(m => m.RefresherPageModule)
    },
    {
        path: 'searchbar',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-searchbar-searchbar-module */ "pages-searchbar-searchbar-module").then(__webpack_require__.bind(null, /*! ./pages/searchbar/searchbar.module */ "./src/app/pages/searchbar/searchbar.module.ts")).then(m => m.SearchbarPageModule)
    },
    {
        path: 'segment',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-segment-segment-module */ "pages-segment-segment-module").then(__webpack_require__.bind(null, /*! ./pages/segment/segment.module */ "./src/app/pages/segment/segment.module.ts")).then(m => m.SegmentPageModule)
    },
    {
        path: 'slides',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-slides-slides-module */ "pages-slides-slides-module").then(__webpack_require__.bind(null, /*! ./pages/slides/slides.module */ "./src/app/pages/slides/slides.module.ts")).then(m => m.SlidesPageModule)
    },
    {
        path: 'tabs',
...
module.exports = __webpack_require__(/*! C:\Users\User\Desktop\ionic\04-componentes\src\main.ts */"./src/main.ts");
