...
/* harmony default export */ __webpack_exports__["default"] = ("<app-header titulo=\"refresher\" ></app-header>\n\n<ion-content padding>\n\n  <ion-refresher slot=\"fixed\" (ionRefresh)=\"doRefresh($event)\">\n    <ion-refresher-content></ion-refresher-content>\n  </ion-refresher>\n\n  <h1 *ngIf=\"items.length == 0\">Baja para refrescar :D</h1>\n  \n  <ion-list *ngIf=\"items.length != 0\">\n    <ion-item *ngFor=\"let item of items; let i = index\">\n      Elemento {{i+1}}\n    </ion-item>\n  </ion-list>\n</ion-content>\n");
...
/* harmony import */ var _refresher_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./refresher.page */ "./src/app/pages/refresher/refresher.page.ts");
...
/* harmony import */ var _refresher_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./refresher-routing.module */ "./src/app/pages/refresher/refresher-routing.module.ts");
...
RefresherPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./refresher.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/refresher/refresher.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./refresher.page.scss */ "./src/app/pages/refresher/refresher.page.scss")).default]
    })
], RefresherPage);
...
//# sourceMappingURL=pages-refresher-refresher-module-es2015.js.map