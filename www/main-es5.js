...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-botones-botones-module */
        "pages-botones-botones-module").then(__webpack_require__.bind(null,
        /*! ./pages/botones/botones.module */
        "./src/app/pages/botones/botones.module.ts")).then(function (m) {
          return m.BotonesPageModule;
        });
      }
    }, {
      path: 'card',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-card-card-module */
        "pages-card-card-module").then(__webpack_require__.bind(null,
        /*! ./pages/card/card.module */
        "./src/app/pages/card/card.module.ts")).then(function (m) {
          return m.CardPageModule;
        });
      }
    }, {
      path: 'check',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-check-check-module */
        "pages-check-check-module").then(__webpack_require__.bind(null,
        /*! ./pages/check/check.module */
        "./src/app/pages/check/check.module.ts")).then(function (m) {
          return m.CheckPageModule;
        });
      }
    }, {
      path: 'date-time',
      loadChildren: function loadChildren() {
        ...
        "pages-date-time-date-time-module").then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-infinite-scroll-infinite-scroll-module */
        "pages-infinite-scroll-infinite-scroll-module").then(__webpack_require__.bind(null,
        /*! ./pages/infinite-scroll/infinite-scroll.module */
        "./src/app/pages/infinite-scroll/infinite-scroll.module.ts")).then(function (m) {
          return m.InfiniteScrollPageModule;
        });
      }
    }, {
      path: 'input',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-input-input-module */
        "pages-input-input-module").then(__webpack_require__.bind(null,
        /*! ./pages/input/input.module */
        "./src/app/pages/input/input.module.ts")).then(function (m) {
          return m.InputPageModule;
        });
      }
    }, {
      path: 'list',
      loadChildren: function loadChildren() {
        ...
        "pages-list-list-module").then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-list-reorder-list-reorder-module */
        "pages-list-reorder-list-reorder-module").then(__webpack_require__.bind(null,
        /*! ./pages/list-reorder/list-reorder.module */
        "./src/app/pages/list-reorder/list-reorder.module.ts")).then(function (m) {
          return m.ListReorderPageModule;
        });
      }
    }, {
      path: 'loading',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-loading-loading-module */
        "pages-loading-loading-module").then(__webpack_require__.bind(null,
        /*! ./pages/loading/loading.module */
        "./src/app/pages/loading/loading.module.ts")).then(function (m) {
          return m.LoadingPageModule;
        });
      }
    }, {
      path: 'modal',
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-progress-bar-progress-bar-module */
        "pages-progress-bar-progress-bar-module").then(__webpack_require__.bind(null,
        /*! ./pages/progress-bar/progress-bar.module */
        "./src/app/pages/progress-bar/progress-bar.module.ts")).then(function (m) {
          return m.ProgressBarPageModule;
        });
      }
    }, {
      path: 'refresher',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-refresher-refresher-module */
        "pages-refresher-refresher-module").then(__webpack_require__.bind(null,
        /*! ./pages/refresher/refresher.module */
        "./src/app/pages/refresher/refresher.module.ts")).then(function (m) {
          return m.RefresherPageModule;
        });
      }
    }, {
      path: 'searchbar',
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-slides-slides-module */
        "pages-slides-slides-module").then(__webpack_require__.bind(null,
        /*! ./pages/slides/slides.module */
        "./src/app/pages/slides/slides.module.ts")).then(function (m) {
          return m.SlidesPageModule;
        });
      }
    }, {
      path: 'tabs',
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar, // se importa el dataService de tipo DataService para poder trabajar con las opciones del menu
      dataService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function initializeApp() {
          ...
          this.platform.ready().then(function () {
            ...
            _this.splashScreen.hide(); // utilizo el componente que no existia asignandole el dataService recvien importado
            // que recupera los valores del menu


            _this.componentes = _this.dataService.getMenu();
          });
        }
      }]);
  ...
  function srcAppComponentsComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _popinfo_popinfo_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    ComponentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_header_header_component__WEBPACK_IMPORTED_MODULE_3__["HeaderComponent"], _menu_menu_component__WEBPACK_IMPORTED_MODULE_5__["MenuComponent"], _popinfo_popinfo_component__WEBPACK_IMPORTED_MODULE_7__["PopinfoComponent"]],
      // todos los modulos
      exports: [_header_header_component__WEBPACK_IMPORTED_MODULE_3__["HeaderComponent"], _menu_menu_component__WEBPACK_IMPORTED_MODULE_5__["MenuComponent"], _popinfo_popinfo_component__WEBPACK_IMPORTED_MODULE_7__["PopinfoComponent"]],
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        ...
        value: function getHeroes() {
          return this.http.get('/assets/data/superheroes.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(2000));
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\User\Desktop\ionic\04-componentes\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
